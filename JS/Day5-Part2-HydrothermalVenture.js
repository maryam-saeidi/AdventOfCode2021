...
function markDiagonalLine(coordinate) {
  const minusX = coordinate[0][0] > coordinate[1][0];
  const minusY = coordinate[0][1] > coordinate[1][1];
  const initialCoordinate = [coordinate[0][0], coordinate[0][1]];

  while (initialCoordinate[0] !== coordinate[1][0] && initialCoordinate[1] !== coordinate[1][1]) {
    surface[initialCoordinate[1]][initialCoordinate[0]]++;
    initialCoordinate[0] = minusX ? initialCoordinate[0] - 1 : initialCoordinate[0] + 1;
    initialCoordinate[1] = minusY ? initialCoordinate[1] - 1 : initialCoordinate[1] + 1;
  }
  surface[initialCoordinate[1]][initialCoordinate[0]]++;
}
